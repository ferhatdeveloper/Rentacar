...
class PaymentMethodSelector extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final methods = [
      ...
      (IraqPaymentMethod.nebula, Icons.point_of_sale, l10n.paymentNebulaDesc),
    ];
              ...
              ...methods.map((m) {
                ...
                return Card(
                  ...
                  child: RadioListTile<IraqPaymentMethod>(
                      ...
                      children: [
                        ...
                        if (method == IraqPaymentMethod.nebula)
                          nebulaStatus.when(
                            ...
                            data: (connected) => Text(
                              connected
                                  ? 'Nebula: terminal bağlı'
                                  : 'Nebula: terminal bağlı değil',
                              style: TextStyle(
                                fontSize: 11,
                                color: connected
                                    ? AppColors.success
                    ...
                    secondary: Icon(
                      m.$2,
                      color: isSelected ? AppColors.amber : null,
                    ),
                  ),
                );
              }),
